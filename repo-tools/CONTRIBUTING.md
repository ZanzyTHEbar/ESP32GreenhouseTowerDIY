...
* Contributing missing documentation for features and devices in our [documentation](https://ZanzyTHEBar.github.io/ESP32GreenhouseDIY/)
...
* Fork the OpenAir Cyan Repository [git repository](https://github.com/ZanzyTHEbar/ESP32GreenhouseTowerDIY).
* Write/Change the code in your Fork for a new feature, bug fix, new sensor, optimization, etc.
* Ensure tests work.
* Create a Pull Request against the [**development**](https://github.com/ZanzyTHEbar/ESP32GreenhouseTowerDIY/tree/dev) branch of OpenAir Cyan.
