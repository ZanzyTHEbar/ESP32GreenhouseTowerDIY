...
// Constructor, not much going on. Just passing the pin number in and the input state.
Buttons::Buttons(byte inPin, bool input) : mechButton(inPin), _messageCallback(nullptr),
