...
jq --arg a "$nextReleaseVersion" '.version = $a' ./Code/PlatformIO Project/lib/GreenHouseTowerDIY/library.json > "$tmp" && mv "$tmp" ./Code/PlatformIO Project/lib/GreenHouseTowerDIY/library.json -f
